...
function addpaycc() {
    ...
    let c = cart.indexOf(objpaycash)
    if (c>=0) {
        cart.splice(c, 1)
        paycash.style.backgroundColor = 'rgb(187,153,209)';
    }
    cart.push(objpaycc)
...
function addpaycash() {
        ...
        if (cart[j] === objmcp12) {
            for (let k = 0; k < cart.length; k += 1) {
                if (cart[k] === objpaycc) {
                    showItems()
                    console.log(cart)
                    alert("Not available with Lifestyle commitment")
                    return
                } else {
                    addpaycc()
                    showItems()
        ...
        if (cart[k] === objmcp4) {
            for (let k = 0; k < cart.length; k += 1) {
                if (cart[k] === objpaycc) {
                    showItems()
                    console.log(cart)
                    alert("Not available with Premier commitment")
                    return
                } else {
                    addpaycc()
                    showItems()
    ...
    let c = cart.indexOf(objpaydd)
    if (c>=0) {
        cart.splice(c, 1)
        paydd.style.backgroundColor = 'rgb(187,153,209)';
    }
    cart.push(objpaycash)
    paycash.style.backgroundColor = 'rgb(39,253,204)';
    showItems()
    console.log(cart)
}
